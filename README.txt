...
Пример кода
Проект:  https://github.com/OwerZeroTwo/tasklist_project
...
Пример кода
Проект:  https://github.com/OwerZeroTwo/flask_app для запусска python app.py и перейти по ссылке http://127.0.0.1:5000/
Функции
...
Пример кода
Проект: https://github.com/OwerZeroTwo/fastApi_test
